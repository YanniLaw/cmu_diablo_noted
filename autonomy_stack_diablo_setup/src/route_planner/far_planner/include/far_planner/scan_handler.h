...
private:
    ...
    const float ANG_RES_Y = 2.0f/180.0f * M_PI; // vertical resolution 2 degree VL16多线雷达的垂直分辨率
    const float ANG_RES_X = 0.5f/180.0f * M_PI; // horizontal resolution 0.5 degree VL16多线雷达的水平分辨率
